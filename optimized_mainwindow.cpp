...
// ============================================================================
// OptimizedMainWindow Implementation
// ============================================================================
    ...
    performanceMonitoringEnabled(true)
{
    ...
    connect(serverManager, &ServerManager::serverReady, this, &OptimizedMainWindow::onServerReady);
    connect(serverManager, &ServerManager::serverError, this, &OptimizedMainWindow::onServerError);
    
    // Connect performance monitor
    connect(performanceMonitor, &PerformanceMonitor::performanceUpdate, 
            this, &OptimizedMainWindow::onPerformanceUpdate);
    
    // Setup performance monitoring
    initializePerformanceMonitoring();
    
    // Preload resources in background
    QTimer::singleShot(0, this, &OptimizedMainWindow::preloadResources);
...
OptimizedMainWindow::~OptimizedMainWindow()
{
...
void OptimizedMainWindow::setupOptimizedUI()
{
    ...
    connect(deckGridView, &DeckGridView::deckSelected, this, &OptimizedMainWindow::onDeckSelected);
    ...
    connect(createDeckButton, &QPushButton::clicked, this, &OptimizedMainWindow::onCreateDeckClicked);
    
    // Settings button
    QPushButton *settingsButton = new QPushButton("Settings", buttonContainer);
    settingsButton->setObjectName("settingsButton");
    settingsButton->setMinimumSize(150, 40);
    connect(settingsButton, &QPushButton::clicked, this, &OptimizedMainWindow::onSettingsClicked);
...
void OptimizedMainWindow::initializePerformanceMonitoring()
{
...
void OptimizedMainWindow::preloadResources()
{
...
void OptimizedMainWindow::optimizeMemoryUsage()
{
...
void OptimizedMainWindow::onServerReady()
{
...
void OptimizedMainWindow::onServerError(const QString& error)
{
...
void OptimizedMainWindow::onPerformanceUpdate(const QVariantMap& stats)
{
    ...
    if (stats.contains("memoryPercent")) {
        ...
        if (memoryPercent > 80.0) {
            ...
            QTimer::singleShot(0, this, &OptimizedMainWindow::optimizeMemoryUsage);
        }
    }
...
void OptimizedMainWindow::onDeckSelected(const QString& deckId)
{
    ...
    performanceMonitor->recordOperation("deck_selection", duration);
}

void OptimizedMainWindow::onCreateDeckClicked()
{
    qint64 startTime = QDateTime::currentMSecsSinceEpoch();
    ...
    qint64 duration = QDateTime::currentMSecsSinceEpoch() - startTime;
    performanceMonitor->recordOperation("create_deck_dialog", duration);
}

void OptimizedMainWindow::onSettingsClicked()
{
...
#include "optimized_mainwindow.moc"